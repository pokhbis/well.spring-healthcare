...
import { faTwitterSquare, faFacebook, faLinkedin, faCoffee } from '@fortawesome/free-solid-svg-icons';
const Footer = () => {
    return (
        <div className="">
            <div className="footer-container mt-5 ">
                <div className="row">
                    <div className="col-lg-3">
                        ...
                        {/* <h3 className="footer-text">Well.Spring</h3> */}
                    ...
                    <div className="col-lg-3 pt-4">
                        ...
                        <ul className="footer-social-media">
                            ...
                            {/* <li><FontAwesomeIcon icon={faCoffee}></FontAwesomeIcon> FaceBook</li> */}
                            {/* <li> <FontAwesomeIcon icon={faTwitterSquare}></FontAwesomeIcon>Instagram</li> */}
